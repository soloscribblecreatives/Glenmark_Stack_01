...
var arrSurveyQuestions = {
   2: "How do you rate the brand name SACU-V for ease of brand recall on the scale of 1-5?"
};
...
switch(pg_id){
	case 1:
	content='<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><div class="background"><img src="slide1/1.png" width="1024" height="768" alt=""></div><div class="s1_1"><img src="slide1/2.png"></div><div class="s1_2_wrap"><div class="s1_2"><img src="slide1/3.png"></div></div><div class="s1_3"><img src="slide1/4.png"></div><div class="s1_4"><img src="slide1/5.png"></div><div class="s1_5"><img src="slide1/6.png"></div>';
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="background"><img src="slide2/1.jpg" width="1024" height="768" alt=""></div><div class="bullet1"><img src="slide2/2.png"></div><div class="bullet2"><img src="slide2/2.png"></div><div class="bullet3"><img src="slide2/2.png"></div><div class="bullet4"><img src="slide2/2.png"></div><div class="bullet5"><img src="slide2/2.png"></div>';
	break;
}
