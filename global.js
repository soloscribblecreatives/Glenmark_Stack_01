...
function playVid4() {
	...
	document.getElementById("zidVideo").play();
}
...
function playVid5() {
	...
	var vid = document.getElementById("zidVideo");
	vid.pause();
	vid.currentTime = 0;
